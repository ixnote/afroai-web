...
const Resources = () => {
  return (
    <div>
      <section className="h-auto min-h-[800px] py-20 lg:pt-20 text-primary-50 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-around mt-12 h-auto gap-6 ">
          ...
          >
            <Image
              src={resources1}
              alt=""
              className="w-full h-48 md:h-80 object-cover rounded-t-xl"
            />
            <div className="p-6 bg-black text-primary-50 rounded-b-xl">
              <button className="font-thin px-6 py-3 text-primary-50 rounded-lg mb-4">
                WEBINARS
              </button>
      ...
      <section className="h-auto min-h-[800px] py-4  lg:pt-8 text-primary-50  max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between py-8">
          <div className="flex gap-2 flex-wrap">
            <button className="border px-4 lg:px-10 py-2 rounded-lg border-primary-100 text-primary-100">
              Featured
            </button>
            <button className="border px-4 lg:px-10 py-2 rounded-lg border-primary-50 text-primary-50">
              Article
            </button>
            <button className="border px-4 lg:px-10 py-2 rounded-lg border-primary-50 text-primary-50">
              Case Studies
          ...
          <h2 className="font-thin mt-4 lg:mt-0">
            showing: <span className="font-inter">Featured</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-16 md:py-">
          <div className="w-full border rounded-xl cursor-pointer overflow-hidden">
            <Image
              src={resources3}
              alt=""
              height={400}
            ...
            <h2 className="py-3 text-xl md:text-2xl font-inter bg-black text-primary-50 px-6">
