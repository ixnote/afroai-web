...
const Hero = () => {
  return (
    <div className="h-screen flex flex-col py-28 items-center border">
      <div className="w-full flex flex-col">
        <div className="text-primary-50 px-4 sm:px-10 font-inter flex flex-col items-center md:items-start">
          <div className="text-[36px] sm:text-[48px] flex gap-1 md:text-[72px] lg:text-[105px] text-center md:text-left mt-0 md:mt-20 leading-tight md:leading-[100px]">
