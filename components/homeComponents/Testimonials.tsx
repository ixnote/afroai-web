...
const items = [
  {
    src: testimonial1,
    alt: "Testimonial 1",
    text: "Afro AI has transformed the way I approach problem-solving in my business. Its intuitive AI solutions not only understand our local context but also provides actionable insights that drive real results. Highly recommended.",
    author: "Samuel",
    role: "Entrepreneur",
  },
  {
    src: testimonial2,
    alt: "Testimonial 2",
    text: "As a student, Afro AI's Campus Genie has been a game changer for my academic journey. It not only help me stay organized with my coursework but also provides valuable resources tailored to my university experience. Thank you, Afro AI, for making study easier and more enjoyable!",
    author: "Fatimah",
  ...
  },
  {
    src: testimonial3,
    alt: "Testimonial 3",
    text: " I have been using Afro AI for my organization's data analysis needs and I'm thoroughly impressed. The platforms ability to handle large datasets while still providing accurate insight is remarkable. It has become invaluable asset to our decision making process",
    author: "Emeka",
    role: "Data Analyst",
  },
  {
    src: testimonial4,
    alt: "Testimonial 4",
    text: "Afro AI is a breath of fresh air in the AI landscape. Its commitment to understanding and catering for African nuances set it apart from othq platforms. With Afro AI, I feel confident that I'm using AI that truly reflects my culture and values!.",
    author: "OluwaTosin",
    role: "AI Enthusiast",
  },
  {
